...
function Header() {
  return (
    <header>
        ...
        {/*Top */}
        <div className='flex items-center bg-amazon_blue px-2 flex-grow py-2' > 
            ...
            <div className='text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap'>
              <div onClick={signIn} className='cursor-pointer link'>
                <p className='hover:underline' >Aishwarya Nalawade</p>
              ...
              <div className='relative link flex items-center'>
                <span className='absolute top-0 right-0 md:right-10 h-4 w-4 text-center rounded-full text-black bg-yellow-400'>4</span>
